window.jsonBoardObject = {
  "boards": {
    "feather-esp32": {
      ...
      "image": "boards/feather-esp32/image.svg",
      "totalAnalogPins": 14,
      "i2cPorts": [
        {
          "i2cPortId": 0,
    ...
    "feather-esp32-v2": {
      ...
      "image": "boards/feather-esp32-v2/image.svg",
      "totalAnalogPins": 7,
      "i2cPorts": [
        {
          "i2cPortId": 0,
    ...
    "feather-esp32c6": {
      ...
      "image": "boards/feather-esp32c6/image.png",
      "totalAnalogPins": 6,
      "i2cPorts": [
        {
          "i2cPortId": 0,
    ...
    "feather-esp8266": {
      ...
      "pins": [
        ...
        },
        {
          "number": 16,
          "name": "D16",
          "displayName": "D16 - Deep Sleep Wake Pin",
          "hasPWM": true,
          "hasServo": true
        }
      ],
      ...
      "image": "boards/feather-esp8266/image.png",
      "totalAnalogPins": 1,
      "i2cPorts": [
        {
          "i2cPortId": 0,
    ...
    "itsybitsy-esp32": {
      ...
      "image": "boards/itsybitsy-esp32/image.svg",
      "totalAnalogPins": 6,
      "i2cPorts": [
        {
          "i2cPortId": 0,
    ...
    "metro-m4-airliftlite-tinyusb": {
      "boardName": "metro-m4-airliftlite-tinyusb",
      "mcuName": "samd51j20",
      "referenceVoltage": 3.3,
      "displayName": "Metro M4 Airlift Lite",
      "vendor": "Adafruit",
      "productURL": "https://www.adafruit.com/product/4000",
      ...
      "image": "boards/metro-m4-airliftlite-tinyusb/image.png",
      "totalAnalogPins": 6,
      "i2cPorts": [
        {
          "i2cPortId": 0,
    ...
    "microchip-mcp2221": {
      ...
      "image": "boards/microchip-mcp2221/image.png",
      "totalAnalogPins": 3,
      "i2cPorts": [
        {
          "i2cPortId": 0,
    ...
    "pyportal-tinyusb": {
      "boardName": "pyportal-tinyusb",
      "mcuName": "samd51j20",
      "referenceVoltage": 3.3,
      "displayName": "PyPortal",
      "vendor": "Adafruit",
      "productURL": "https://www.adafruit.com/product/4116",
      ...
      "image": "boards/pyportal-tinyusb/image.png",
      "totalAnalogPins": 4,
      "i2cPorts": [
        {
          "i2cPortId": 0,
    ...
    "pyportal-titano-tinyusb": {
      ...
      "image": "boards/pyportal-titano-tinyusb/image.png",
      "totalAnalogPins": 4,
      "i2cPorts": [
        {
          "i2cPortId": 0,
    ...
    "qtpy-esp32": {
      "boardName": "qtpy-esp32",
      "mcuName": "esp32",
      "referenceVoltage": 3.3,
      "displayName": "Adafruit QT Py ESP32 Pico",
      "vendor": "Adafruit",
      "productURL": "https://www.adafruit.com/product/5395",
      ...
      "image": "boards/qtpy-esp32/image.svg",
      "totalAnalogPins": 8,
      "i2cPorts": [
        {
          "i2cPortId": 0,
    ...
    "qtpy-esp32c3": {
      "boardName": "qtpy-esp32c3",
      "mcuName": "esp32c3",
      "referenceVoltage": 2.6,
      "displayName": "Adafruit QT Py ESP32-C3",
      "vendor": "Adafruit",
      ...
      "image": "boards/qtpy-esp32c3/image.svg",
      "totalAnalogPins": 7,
      "i2cPorts": [
        {
          "i2cPortId": 0,
    ...
    "sparklemotionmini-esp32": {
      ...
      "image": "boards/sparklemotionmini-esp32/image.svg",
      "totalAnalogPins": 7,
      "i2cPorts": [
        {
          "i2cPortId": 0,
    ...
    "feather-rp2040-adalogger": {
      ...
      "pins": [
        ...
        },
        {
          "number": 17,
          "name": "D17",
          "displayName": "GPIO17 (A1/SCK/SD CS)",
          "hasPWM": true,
          "hasServo": true
        },
        {
